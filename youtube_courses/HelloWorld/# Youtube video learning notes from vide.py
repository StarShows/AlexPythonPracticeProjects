...
# Formatted strings: ( `${first} name`) - in js
first = "john"
last = "smith"
...
if len(course) > 20:
    ...
    print(str(len(course)) + f' chars in sentence: {course}')
...
x * y * z
# or in shorthand, Unpacking example:
x, y, z = coordinates
print(x)
...
# Lesson 15 - dictionaries (objects)
# use information as key value pairs
...
# print(customer["name"]) # will work

# print(customer["Name"]) # Will throw error

# Get object info without throwing error, second parameter sets default value
print("prev name:", customer.get("name", "Alex T"))

# Update the value of an object key
customer["name"] = "Alex Tan"
print("Updated name:", customer.get("name"))

# Add a new key and value
customer["birthdate"] = "march 26 1992"
print(customer.get("birthdate"))


# Excersize - input: phone number in digits, output: string value for each number
numbers = {}
numbers_in_words = ["Zero","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten"]
for number in range(0,11):
    numbers[number] = numbers_in_words[number]
